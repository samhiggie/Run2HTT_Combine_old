...
class UncertaintySplitter():
    ...
    def SplitMeasurement(self,Command,OutputDir):
        ...
        os.system(Command+" &> "+OutputDir+"SplitOutput.txt")
        #then freeze the systs
        os.system(Command+" --freezeNuisanceGroups Syst &>> "+OutputDir+"SplitOutput.txt")
        #then freeze the auto mc stats
        os.system(Command+" --freezeNuisanceGroups autoMCStats &>> "+OutputDir+"SplitOutput.txt")
        ...
        Stat_Var_Up = Sigma_Up[1]*Sigma_Up[1]+Sigma_Up[2]*Sigma_Up[2]-Sigma_Up[0]*Sigma_Up[0]
        Syst_Var_Up = Sigma_Up[0]*Sigma_Up[0]-Sigma_Up[1]*Sigma_Up[1]
        BBB_Var_Up = Sigma_Up[0]*Sigma_Up[0]-Sigma_Up[2]*Sigma_Up[2]
        Stat_Var_Down = Sigma_Down[1]*Sigma_Down[1]+Sigma_Down[2]*Sigma_Down[2]-Sigma_Down[0]*Sigma_Down[0]
        Syst_Var_Down = Sigma_Down[0]*Sigma_Down[0]-Sigma_Down[1]*Sigma_Down[1]
        BBB_Var_Down = Sigma_Down[0]*Sigma_Down[0]-Sigma_Down[2]*Sigma_Down[2]
        ...
        os.system(Command+" --freezeNuisanceGroups Syst &>> "+OutputDir+"SplitOutput.txt")
        #then freeze the auto mc stats
        os.system(Command+" --freezeNuisanceGroups Syst,autoMCStats &>> "+OutputDir+"SplitOutput.txt")
        ...
        #print(Sigma_Up)
        #print(Sigma_Down)
        Stat_Var_Up = Sigma_Up[2]*Sigma_Up[2]
        BBB_Var_Up = Sigma_Up[1]*Sigma_Up[1]-Stat_Var_Up        
        Syst_Var_Up = Sigma_Up[0]*Sigma_Up[0]-Stat_Var_Up-BBB_Var_Up
        Stat_Var_Down = Sigma_Down[2]*Sigma_Down[2]
        BBB_Var_Down = Sigma_Down[1]*Sigma_Down[1]-Stat_Var_Down        
        Syst_Var_Down = Sigma_Down[0]*Sigma_Down[0]-Stat_Var_Down-BBB_Var_Down
