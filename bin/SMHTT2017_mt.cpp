...
int main(int argc, char **argv) {
  ...
  //TauID Uncertainty: applied to genuine tau contributions
  cb.cp().process(sig_procs).AddSyst(cb,"CMS_t_ID_eff","lnN",SystMap<>::init(1.02));

  //removed in favor not renormalizing shapes
  ...
  if(not Input.OptionExists("-s"))
    {
      ...
      //TES Uncertainty
      cb.cp().process({"ggH_htt125","qqH_htt125","WH_htt125","ZH_htt125"}).AddSyst(cb,"CMS_scale_t_1prong", "shape", SystMap<>::init(1.00));
      cb.cp().process({"ggH_htt125","qqH_htt125","WH_htt125","ZH_htt125"}).AddSyst(cb,"CMS_scale_t_3prong", "shape", SystMap<>::init(1.00));
      cb.cp().process({"ggH_htt125","qqH_htt125","WH_htt125","ZH_htt125"}).AddSyst(cb,"CMS_scale_t_1prong1pizero", "shape", SystMap<>::init(1.00));
